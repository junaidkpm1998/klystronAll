...
class OutstandingStatement(models.AbstractModel):
    ...
    def _display_lines_sql_q1(self, partners, date_end, account_type):
        ...
        return str(
            ...
            CASE WHEN m.destination_location IS NOT NULL
                THEN sdl.name
                ELSE ''
            ...
            LEFT JOIN sale_destination_location sdl ON (sdl.id = m.destination_location)
            ...
            GROUP BY l.id, l.partner_id, m.name, l.date, l.date_maturity, l.name, m.destination_location, sdl.name,
                CASE WHEN l.ref IS NOT NULL
                    THEN l.ref
                    ELSE m.ref
                END,
    ...
    def _display_lines_sql_q2(self):
        return str(
            self._cr.mogrify(
                """
                SELECT Q1.partner_id, Q1.destination_location, Q1.currency_id, Q1.move_id,
    ...
    def _display_lines_sql_q3(self, company_id):
        return str(
            ...
            SELECT Q2.partner_id, Q2.move_id, Q2.date, Q2.date_maturity,
              Q2.name, Q2.destination_location, Q2.ref, Q2.debit, Q2.credit,
    ...
    def _get_account_display_lines(
        ...
        SELECT partner_id, currency_id, move_id, date, date_maturity, debit,
                            credit, amount, open_amount, name, ref, blocked, destination_location
        FROM Q3
