...
class SalesRegisterWizard(models.TransientModel):
    ...
    def button_sales_register_report(self):
    ...
    def _print_report(self, data):
        res = {}
        data = {
            'model': 'sales.register.report.wizard',
            'form': self.read()[0]
        }
        return self.env.ref('kg_ultracare_sale.action_sales_register_report').with_context(
