...
class CashReceiptsRegisterReport(models.AbstractModel):
    _name = 'report.kg_ultracare_accounting.cash_receipts_reg_template'
    _description = 'Cash Receipts Register Report'
