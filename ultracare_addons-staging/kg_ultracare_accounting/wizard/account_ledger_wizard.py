...
class AccountLedgerWizard(models.TransientModel):
    ...
    def button_account_ledger_report(self):
    ...
    def _print_report(self, data):
        res = {}
        data = {
            'model': 'account.ledger.report.wizard',
            'form': self.read()[0]
        }
        return self.env.ref('kg_ultracare_accounting.action_account_ledger_report').with_context(
