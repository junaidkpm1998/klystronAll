...
class cashBookWizard(models.TransientModel):
    ...
    def button_cash_book_report(self):
    ...
    def _print_report(self, data):
        res = {}
        data = {
            'model': 'cash.book.report.wizard',
            'form': self.read()[0]
        }
        return self.env.ref('kg_ultracare_accounting.action_cash_book_report').with_context(
