...
class BankStatusWizard(models.TransientModel):
    """Bank Status wizard."""

    _name = 'bank.status.report.wizard'
    ...
    def button_bank_status_report(self):
            self.ensure_one()
    ...
    def _print_report(self, data):
        res = {}
        data = {
            'model': 'bank.status.report.wizard',
            'form': self.read()[0]
        }
        return self.env.ref('kg_ultracare_accounting.action_bank_status_report').with_context(
