...
class PDCMaturityWizard(models.TransientModel):
    """PDC Maturity wizard."""

    _name = 'pdc.maturity.report.wizard'
    ...
    def button_pdc_maturity_report(self):
            self.ensure_one()
    ...
    def _print_report(self, data):
        res = {}
        data = {
            'model': 'pdc.maturity.report.wizard',
            'form': self.read()[0]
        }
        return self.env.ref('kg_ultracare_accounting.action_pdc_maturity_report').with_context(
